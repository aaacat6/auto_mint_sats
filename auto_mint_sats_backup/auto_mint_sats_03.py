...
def get_median_fee():
    ...
    # # 获取所有的 medianFee
    # all_median_fees = [block['medianFee'] for block in data]
    # # 计算平均值
    # average_median_fee = sum(all_median_fees) / len(all_median_fees)
    # return average_median_fee
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            # 在每次循环结束时执行新的命令，无论median_fee的值是多少
            # send_message_and_execute_command(f"WalletBalance", command_wallet_balance)    
